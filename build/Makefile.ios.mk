...
LDFLAGS += -Wl,-all_load $(TSROOT)/lib/ios/$(ARCH)/libTellusim_arm64$(POSTFIX).a
...
LDFLAGS += -miphoneos-version-min=16.0
...
#
ifeq "$(CAMERA)" "1"
	LIBS += -framework Foundation -framework CoreMedia -framework CoreVideo -framework VideoToolbox -framework AVFoundation
	BUILD += -camera
endif
