...
def main(argv):
	...
	def format_r_callback(slider): return "Value: " + String.fromf32(slider.valuef32, 2)
	def format_g_callback(slider): return "Value: " + String.fromf32(slider.valuef32, 2)
	def format_b_callback(slider): return "Value: " + String.fromf32(slider.valuef32, 2)
	slider_r.setFormatCallback(format_r_callback)
	slider_g.setFormatCallback(format_g_callback)
	slider_b.setFormatCallback(format_b_callback)
