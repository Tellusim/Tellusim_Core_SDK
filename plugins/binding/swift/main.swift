...
func main_() -> Int32 {
	...
	slider_r.setFormatCallback(ControlSlider.FormatFunction({ (slider: ControlSlider) -> String in "Value: " + TSString.fromf32(slider.valuef32(), 2) }))
	slider_g.setFormatCallback(ControlSlider.FormatFunction({ (slider: ControlSlider) -> String in "Value: " + TSString.fromf32(slider.valuef32(), 2) }))
	slider_b.setFormatCallback(ControlSlider.FormatFunction({ (slider: ControlSlider) -> String in "Value: " + TSString.fromf32(slider.valuef32(), 2) }))
