...
int32_t main(int32_t argc, char **argv) {
	...
	// create window
	String title = String::format("%s Tellusim::GLESRuntime", window.getPlatformName());
	...
	// get functions
	PFNGLDRAWELEMENTSBASEVERTEXPROC glDrawElementsBaseVertex = (PFNGLDRAWELEMENTSBASEVERTEXPROC)GLESContext::getProcAddress("glDrawElementsBaseVertex");
