...
int32_t main(int32_t argc, char **argv) {
	...
	if(!pipeline.loadShader(Shader::TypeVertex, "main.metal", "VERTEX_SHADER=1")) return 1;
	if(!pipeline.loadShader(Shader::TypeFragment, "main.metal", "FRAGMENT_SHADER=1")) return 1;
